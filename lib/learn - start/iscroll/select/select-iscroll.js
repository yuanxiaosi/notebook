(function(w){
  var IScroll = function(id, cb){
    ...
    me.wrapper.addEventListener('touchstart', function(e){
      me.limitY = 0;
      me.scrollerLi[me.scrollerIndex].style.color = '#ccc';
      me.startY = e.touches[0].clientY;
      me.startTime = new Date().getTime();
      scrollStart();
      return false;
    })
    me.wrapper.addEventListener('touchmove', function(e){
      me.moveY = e.touches[0].clientY - me.startY;
    ...
    me.wrapper.addEventListener('touchend', function(e){
